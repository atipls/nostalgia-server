...
use protocol::Packet;
use std::{num::NonZeroU32, path::PathBuf, sync::Arc, arch::{is_aarch64_feature_detected, aarch64}};
use tokio::sync::{
...
async fn main() {
    ...
    let packet_bytes: [u8; 87] = [
        0x84, 0xd0, 0x04, 0x00, 0x40, 0x00, 0x70, 0x8c,
        0x03, 0x00, 0x97, 0x00, 0x00, 0x00, 0x02, 0x00,
        0x00, 0x00, 0x81, 0x00, 0x00, 0x00, 0x81, 0x40,
        0x40, 0x01, 0x80, 0x8d, 0x03, 0x00, 0xa3, 0x00,
        0x00, 0x40, 0xef, 0xff, 0xff, 0xb9, 0x93, 0xff,
        0xff, 0xab, 0x1d, 0x00, 0x00, 0x00, 0xff, 0x00,
        0x05, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
        0x00, 0x81, 0xe6, 0x48, 0x2b, 0x90, 0x00, 0x00,
        0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0xc8, 0x3d,
        0xd8, 0x43, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00,
        0x30, 0xac, 0x01, 0x00, 0x00, 0x00, 0x02
      ];
